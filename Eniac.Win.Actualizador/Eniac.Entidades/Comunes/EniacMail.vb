...
Namespace Entidades
   Public Class EniacMail
      Public Shared Sub EnviarMail(mensaje As String)
         ...
         ''            .From = New MailAddress("soporte@sinergiasoftware.com.ar")

         ''            .To.Add("soporte@sinergiasoftware.com.ar")

         ''            .Subject = "Error - " + Usuarios.Actual.Sucursal.NombreEmpresa + " - " + Usuarios.Actual.Nombre + " - " + My.Computer.Name
         ''            .IsBodyHtml = True
         ...
         ''         smt.Port = 26
         ''         smt.Host = "mail.sinergiasoftware.com.ar"
         ''         smt.Credentials = New System.Net.NetworkCredential("soporte@sinergiasoftware.com.ar", "Bandera98")
      ...
      Private Shared Function ArmarMail(mensaje As String) As String
         Dim stb = New System.Text.StringBuilder()
