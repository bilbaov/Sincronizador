...
#Region "Overrides"
   ...
   Private Sub Actualiza(entidad As Eniac.Entidades.Entidad)
      Me.EjecutaSP(entidad, TipoSP._U)
   End Sub

   Private Sub Borra(entidad As Eniac.Entidades.Entidad)
   ...
   Private Sub CargarUno(o As Entidades.VersionScript, dr As DataRow)
      With o
         ...
         If Not String.IsNullOrEmpty(dr(Entidades.VersionScript.Columnas.CodigoCliente.ToString()).ToString()) Then
            .Cliente = New Reglas.Clientes(Me.da).GetUnoPorCodigo(Long.Parse(dr(Entidades.VersionScript.Columnas.CodigoCliente.ToString()).ToString()))
         End If
